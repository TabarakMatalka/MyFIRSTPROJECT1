...
namespace firstProjectTest.Controllers
{
    public class RolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RoleName,RoleDescription")] Role role)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,RoleName,RoleDescription")] Role role)
        {
            if (id != role.Id)
            {
                return NotFound();
