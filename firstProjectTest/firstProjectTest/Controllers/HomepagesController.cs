...
namespace firstProjectTest.Controllers
{
    public class HomepagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PageId,Title,Paragraph,Image")] Homepage homepage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("PageId,Title,Paragraph,Image")] Homepage homepage)
        {
