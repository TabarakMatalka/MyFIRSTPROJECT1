    ...
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Payments != null ? 
                          ...
                          Problem("Entity set 'ModelContext.Payments'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Amount,PaymentDate,PaymentMethod")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Amount,PaymentDate,PaymentMethod")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
